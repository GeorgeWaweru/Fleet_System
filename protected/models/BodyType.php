...
/**
 * This is the model class for table "tbl_body_type".
 *
 * The followings are the available columns in table 'tbl_body_type':
 * @property integer $id
...
class BodyType extends CActiveRecord
{
	...
	public function relations()
	{
		...
		return array(
			'Cars' => array(self::HAS_MANY, 'Cars', 'body_type_id'),
		);
	}

...
class Users extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('role_id, company_id, car_id, qualified_status, status, changed_initial_password', 'numerical', 'integerOnly'=>true),
			...
			array('role_id, id, company_id, car_id, first_name, last_name, email, phone_number, dl_number, photo, dl_photo, qualified_status, raw_password, status, password, changed_initial_password, password_reset_token, created_at', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'CarAssignmentHistories' => array(self::HAS_MANY, 'CarAssignmentHistory', 'user_id'),

...
/**
 * This is the model class for table "tbl_company_suppliers".
 *
 * The followings are the available columns in table 'tbl_company_suppliers':
 * @property integer $id
 ...
 */
class CompanySuppliers extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('supplier_id, company_id, created_at, status', 'required'),
			array('supplier_id, company_id, status', 'numerical', 'integerOnly'=>true),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, supplier_id, company_id, created_at, status', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return CompanySuppliers the static model class
	 */

...
class CarAssignment extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('car_id, user_id, company_id, spare_tire, fire_extinguisher, jerk, wheel_spanner, no_physical_damages, no_mechanical_issues, email_sent, deleted_status, status', 'numerical', 'integerOnly'=>true),
			array('physical_damages, mechanical_issues', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, car_id, user_id, company_id, spare_tire, fire_extinguisher, jerk, wheel_spanner, physical_damages, no_physical_damages, mechanical_issues, no_mechanical_issues, created_at, email_sent, deleted_status, status', 'safe', 'on'=>'search'),
		);
	}

...
/**
 * This is the model class for table "tbl_car_years".
 *
 * The followings are the available columns in table 'tbl_car_years':
 * @property integer $id
 * @property string $title
 * @property integer $status
 */
class CarYears extends CActiveRecord
{
	/**
	 ...
	 * @return CarYears the static model class
	 */

...
class Companies extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('industry_id, no_employees, no_vehicles, changed_initial_password, is_default, status', 'numerical', 'integerOnly'=>true),
			...
			array('id, industry_id, title, photo, contact_person, email, phone_number, location, no_employees, no_vehicles, raw_password, password, changed_initial_password, password_reset_token, is_default, status', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'CarAssignments' => array(self::HAS_MANY, 'CarAssignment', 'company_id'),
	...
	public	function getRandomNumber($length = 4) {
	 ...
	 public function ReportImage($banner_name,$path)
	 {
		 ...
		 echo $site_path.$path."/".$banner_name;
	 }

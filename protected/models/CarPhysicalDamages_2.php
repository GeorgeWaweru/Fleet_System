...
/**
 * This is the model class for table "tbl_car_physical_damages".
 *
 * The followings are the available columns in table 'tbl_car_physical_damages':
 * @property integer $id
 ...
 */
class CarPhysicalDamages extends CActiveRecord
{
	/**
	...
	{
		return 'tbl_car_physical_damages';
	}
	...
	public function rules()
	{
		...
		return array(
			...
			array('car_id, company_id, status', 'numerical', 'integerOnly'=>true),
			array('photo', 'length', 'max'=>50),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, car_id, company_id, photo, description, created_at, status', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 */ 
	 ...
	 {
		$name='Car';
		echo CHtml::image(Yii::app()->request->baseUrl.'/car_physical_damage/'.$banner_name,$name,array("class"=>"banner_class","width"=>"100px"));
	 }
	 ...
	 * @return CarPhysicalDamages the static model class
	 */

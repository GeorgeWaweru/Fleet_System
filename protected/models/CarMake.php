...
/**
 * This is the model class for table "tbl_car_make".
 *
 * The followings are the available columns in table 'tbl_car_make':
 * @property integer $id
 ...
 * @property TblCarModels[] $tblCarModels
 * @property TblCars[] $tblCars
 */
class CarMake extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('status, is_default', 'numerical', 'integerOnly'=>true),
			array('title', 'length', 'max'=>50),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, title, status, is_default', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'CarModels' => array(self::HAS_MANY, 'CarModels', 'make_id'),
			'Cars' => array(self::HAS_MANY, 'Cars', 'make_id'),
		);
	}
	 ...
	 * @return CarMake the static model class
	 */

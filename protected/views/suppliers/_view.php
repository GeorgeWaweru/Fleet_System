...
<div class="view">
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('raw_password')); ?>:</b>
	<?php echo CHtml::encode($data->raw_password); ?>
	<br />
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('changed_initial_password')); ?>:</b>
	<?php echo CHtml::encode($data->changed_initial_password); ?>
	<br />

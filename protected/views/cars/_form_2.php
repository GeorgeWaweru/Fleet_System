...
<td>
<?php echo $form->textField($model,'car_year',array('size'=>50,'maxlength'=>50,'class'=>'parent_form_elements pure_numeric_fields')); ?>
...
<td>
<?php echo $form->textField($model,'engine_number',array('size'=>50,'maxlength'=>50,'class'=>'parent_form_elements')); ?>
...
<td>
<?php echo $form->textField($model,'tire_size',array('size'=>50,'maxlength'=>50,'class'=>'parent_form_elements pure_numeric_fields_dot')); ?>
...
<td class="inner_fields">Photo</td>
<td>
<?php echo $form->hiddenField($CarMechanicalIssues,'car_id',array('size'=>50,'maxlength'=>50)); ?>
...
<?php echo CHtml::Button($model->isNewRecord ? 'Add' : 'Update',array('onClick'=>'PostCar()','class'=>'parent_form_btn')); ?>
<br><br>
<div id="info_frm"></div>
...
$("form#cars-form").submit(function(event){
	event.preventDefault(); 
	var addUrl='<?php echo Yii::app()->controller->createUrl('Cars/create');?>';
	var updateUrl='<?php echo Yii::app()->controller->createUrl('Cars/update');?>';
	...
	var Cars_car_year=$("#Cars_car_year").val();
	var Cars_chasis_number=$("#Cars_chasis_number").val();
	var Cars_engine_number=$("#Cars_engine_number").val();
	...
	var Cars_tire_size=$("#Cars_tire_size").val();

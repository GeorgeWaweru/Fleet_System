...
$this->menu=array(
	array('label'=>'Add Fuel Request', 'url'=>array('FuelCreate')),
);
...
<h3>Manage Fuel Requests</h3>
<?php echo CHtml::link('Advanced Search','#',array('class'=>'search-button')); ?>
<div class="search-form" style="display:none">
<?php $this->renderPartial('_fuel_search',array(
	'model'=>$model,
)); ?>
</div><!-- search-form -->
...
<a class="export_link" href="<?php echo Yii::app()->controller->createUrl('ExportExcell',array('type'=>'fuel'));?>" target="_blank">Export Excell</a>
</div>
<?php 
$this->widget('zii.widgets.grid.CGridView', array(
	'id'=>'requests-grid',
	'dataProvider'=>$model->search('fuel',$COMPANY_SUB_USER_ROLE,$LOGGED_IN_USER_ID),
	//'filter'=>$model,
	'columns'=>array(
...
*/
		...
		array(
		'header' => 'Previous Millage (KM)',
		'value'=>'$data->previous_millage',
		'htmlOptions'=>array('width'=>'100px'),
		),
		
		array(
		'header' => 'Current Millage (KM)',
		'value'=>'$data->current_millage',
		'htmlOptions'=>array('width'=>'100px'),
		),
		
		array(
		'header' => 'Millage (KM)',
		'value'=>'$data->millage($data->previous_millage,$data->current_millage)',
		'htmlOptions'=>array('width'=>'100px'),
		),
		
		array(
		'header' => 'Current Consumption (KM/L)',
		'value'=>'$data->CurrentFuelConsumption($data->previous_millage,$data->current_millage,$data->fuel_quantity,$data->car->consumption)',
		'htmlOptions'=>array('width'=>'100px'),
		),
		
		array(
		'header' => "Car's Consumption (KM/L)",
		'value'=>'$data->car->consumption',
		'htmlOptions'=>array('width'=>'100px'),
		),
		...
		array(
		'header' => 'Export',
		'value'=>'$data->ExportData($data->id,fuel)',
		'htmlOptions'=>array('width'=>'20px'),
		),
		
		array(
		'header' => 'Job Card',
		'value'=>'$data->BookCar($data->id,repair)',
		'htmlOptions'=>array('width'=>'80px'),
		...
		array(
		'header' => 'Edit / Delete',
		'value'=>'$data->deleteRecord($data->id,"fuel")',
		'htmlOptions'=>array('width'=>'100px'),

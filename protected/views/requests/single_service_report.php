...
$narrative="<font color='#000099'><b>Service Request for</b></font> - ".$Requests_model->requestNarativeReport($Requests->car_id,$Requests->on_behalf,$Requests->user_id,$Requests->request_raised_user_id);

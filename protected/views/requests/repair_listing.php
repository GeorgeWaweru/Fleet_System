...
$this->menu=array(
	array('label'=>'Add Repair Request', 'url'=>array('RepairCreate')),
);
...
<a class="export_link" href="<?php echo Yii::app()->controller->createUrl('ExportExcell',array('type'=>'repair'));?>" target="_blank">Export Excell</a>
</div>

<?php 
$this->widget('zii.widgets.grid.CGridView', array(
	'id'=>'requests-grid',
	'dataProvider'=>$model->search('repair',$COMPANY_SUB_USER_ROLE,$LOGGED_IN_USER_ID),
	//'filter'=>$model,
	'columns'=>array(
		...
		'value'=>'$data->RequestSubDetails($data->id,$data->no_description,"repair")',
		...
		array(
		'header' => 'Export',
		'value'=>'$data->ExportData($data->id,repair)',
		...
		array(
		'header' => 'Edit / Delete',
		'value'=>'$data->deleteRecord($data->id,"repair")',

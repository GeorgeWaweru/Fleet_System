...
if($LOGGED_IN_USER_KIND=='company_user'){
	...
	$header_text="<font color='#000099'><font size='5'><b>".$CompaniesData->title." Repair Requests</b></font></font>";
	$colspan=8;
	...
	$header_text="<font color='#000099'><font size='5'><b>Repair Requests Raised By ".$UsersData->first_name." ".$UsersData->last_name."</b></font></font>";
	$colspan=7;
}

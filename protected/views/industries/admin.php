...
$this->menu=array(
	...
	array('label'=>'Add Industry', 'url'=>array('create')),
);
...
<?php $this->widget('zii.widgets.grid.CGridView', array(
	...
	/*array(
		...
		array(
		'header' => 'Description',
		'value'=>'$data->DisplayHtmlContent($data->industry_desc)',
...
$(".ui-dialog-buttonpane .ui-state-default").click(function() {
	...
	if(box_text=="Yes"){
		adminDeleteRecord('Industries',delete_record_id,'industries-grid');

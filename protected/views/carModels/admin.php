...
$this->menu=array(
	//array('label'=>'List Car Models', 'url'=>array('admin')),
	array('label'=>'Add Car Model', 'url'=>array('create')),
);
...
$('.search-form form').submit(function(){
	$('#car-models-grid').yiiGridView('update', {
		data: $(this).serialize()
	});
	return false;
});
...
$(".ui-dialog-buttonpane .ui-state-default").click(function() {
	...
	if(box_text=="Yes"){
		adminDeleteRecord('CarModels',delete_record_id,'car-models-grid');

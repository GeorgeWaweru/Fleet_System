...
<?php echo CHtml::Button($model->isNewRecord ? 'Add' : 'Update',array('onClick'=>'PostCompany()')); ?>
<br><br>
<div id="info_frm"></div>
			...
			if(Companies_contact_person!==""){
				...
				if(emailReg.test(Companies_email) && Companies_email!=""){
					...
					/*End submit the form*/
									...
									displayError("Please enter the number of vehicles.","no_vehicles_error");
								}
							}else{
								displayError("Please enter the number of employees.","no_employees_error");
							}
						}else{
							displayError("Please enter the location.","location_error");
						}
					}else{
						displayError("Please enter the phone number.","phone_number_error");
					}
				}else{
					displayError("Please enter a valid email address.","email_error");
				}
			}else{
				displayError("Please enter the contact persons name.","contact_person_error");
			}
		}else{
			displayError("Please enter the company name.","title_error");
		}
		}else{
			displayError("Please upload the company's Logo as(.JPG or PNG)","photo_error");
		}
		}else{
			displayError("Please select the Industry.","industries_error");
	}  
}

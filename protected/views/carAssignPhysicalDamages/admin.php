...
$this->menu=array(
	array('label'=>'Add Car Physical Damages', 'url'=>array('create')),
...
$('.search-form form').submit(function(){
	$('#car-assign-physical-damages-grid').yiiGridView('update', {
		data: $(this).serialize()
	});
	return false;
});
...
<h3>Manage Car Physical Damages</h3>
...
<?php $this->widget('zii.widgets.grid.CGridView', array(
	'id'=>'car-assign-physical-damages-grid',
...
$(".ui-dialog-buttonpane .ui-state-default").click(function() {
	...
	if(box_text=="Yes"){
		adminDeleteRecord('CarAssignPhysicalDamages',delete_record_id,'car-assign-physical-damages-grid');

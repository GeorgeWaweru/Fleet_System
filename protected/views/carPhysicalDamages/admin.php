...
$this->menu=array(
	array('label'=>'Add Car Physical Damage', 'url'=>array('create')),
...
$('.search-form form').submit(function(){
	$('#car-physical-damages-grid').yiiGridView('update', {
		data: $(this).serialize()
	});
	return false;
});
...
$(".ui-dialog-buttonpane .ui-state-default").click(function() {
	...
	if(box_text=="Yes"){
		adminDeleteRecord('CarPhysicalDamages',delete_record_id,'car-physical-damages-grid');
